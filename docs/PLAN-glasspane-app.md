...
- #38 [G8] **[TEST STRENGTHENED; venue corrected 2026-08-31]** glasspane-test-ef-absent-paths asserts the EF contribution registers exactly once across re-register and that glasspane-ef-unregister removes it. The contribution now lives in Jetpacs' Modus-family Theme Settings registry rather than the general Settings-link list.
