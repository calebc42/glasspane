...
(defconst jetpacs-node-schema
  '(
    ...
    ("column" ("children") ("align" "arrange" "fill" "scroll" "spacing"))
    ("flow_row" ("children") ("align" "arrange" "run_spacing" "spacing"))
    ("box" ("children") ("alignment" "on_tap"))
    ("surface" ("children") ("color" "elevation" "shape"))
    ("lazy_column" ("children") ("content_padding" "spacing"))
    ("spacer" () ())
    ("divider" () ("color" "thickness"))
    ("card" ("children") ("on_long_tap" "on_tap" "swipe_end" "swipe_start"))
    ...
    ("button" ("label" "on_tap") ("enabled" "icon" "variant"))
    ("icon_button" ("icon" "on_tap") ("badge" "content_description" "enabled"))
    ("chip" ("label") ("enabled" "icon" "on_tap" "selected"))
    ("assist_chip" ("label") ("enabled" "icon" "on_tap"))
    ("menu" ("items") ("enabled" "icon"))
    ("text_input" ("id") ("autofocus" "clear_on_submit" "enabled" "hint" "keyboard" "label" "max_lines" "min_lines" "monospace" "on_change" "on_submit" "password" "single_line" "syntax" "value"))
    ...
    ("switch" ("id") ("checked" "enabled" "label" "on_change"))
    ("enum_list" ("id" "options") ("allow_add" "enabled" "multi_select" "on_change" "value"))
    ("date_button" ("label" "on_pick") ("enabled" "value"))
    ("time_button" ("label" "on_pick") ("enabled" "value"))
    ("slider" ("id" "on_change") ("enabled" "max" "min" "value" "values"))
