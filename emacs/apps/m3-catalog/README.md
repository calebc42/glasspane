...
5. Every tap handler is `(jetpacs-m3-demo "…")`, which pops a real
   `scaffold.snackbar` on the screen you are looking at.  Never register
   new actions from a component module.
