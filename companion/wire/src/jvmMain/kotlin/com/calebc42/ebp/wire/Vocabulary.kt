...
val NODE_SCHEMA: Map<String, NodeRow> = mapOf(
    ...
    "text_input" to NodeRow(setOf("id"), setOf("value", "hint", "label", "on_change", "on_submit", "single_line", "min_lines", "max_lines", "monospace", "syntax", "password", "keyboard", "autofocus", "clear_on_submit", "enabled", "variant", "is_error", "supporting_text", "prefix", "suffix", "leading_icon", "trailing_icon", "max_length")),
    ...
    "slider" to NodeRow(setOf("id", "on_change"), setOf("value", "min", "max", "values", "enabled", "track", "color", "thumb_icon")),
    ...
    "scaffold" to NodeRow(setOf(), setOf("top_bar", "body", "bottom_bar", "fab", "floating_toolbar", "drawer", "snackbar", "snackbar_action", "on_refresh", "top_bar_style", "top_bar_subtitle", "scroll_behavior")),
